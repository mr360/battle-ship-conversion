...
Module MenuController
    ...
    Private ReadOnly MENU_COLOR As Color = Color.FromArgb(255, 2, 167, 252)
    Private ReadOnly HIGHLIGHT_COLOR As Color = Color.FromArgb(255, 1, 57, 86)
    ...
    Public Sub HandleSetupMenuInput()
        'TODO: Step 04: Alter this to check for setting button clicks
        HandleMenuInput(MAIN_MENU, 0, 0)
    End Sub
    ...
    Private Function HandleMenuInput(ByVal menu As Integer, ByVal level As Integer, ByVal xOffset As Integer) As Boolean
        ...
        If Input.MouseWasClicked(MouseButton.LeftButton) Then
            For i As Integer = 0 To _menuStructure(menu).Length - 1
    ...
    Public Sub DrawSettings()
        'TODO: Step 04: Draw the MAIN_MENU and the SETTINGS_MENU
    End Sub
    ...
    ''' </remarks>
    Private Sub DrawButtons(ByVal menu As Integer, ByVal level As Integer, ByVal xOffset As Integer, ByVal highlight As Integer)
        ...
        For i As Integer = 0 To _menuStructure(menu).Length - 1
            ...
            If highlight = i Then
                Text.DrawTextLines(_menuStructure(menu)(i), HIGHLIGHT_COLOR, Color.Black, GameFont("Menu"), FontAlignment.AlignCenter, btnLeft + TEXT_OFFSET, btnTop + TEXT_OFFSET, BUTTON_WIDTH, BUTTON_HEIGHT)
            Else
                Text.DrawTextLines(_menuStructure(menu)(i), MENU_COLOR, Color.Black, GameFont("Menu"), FontAlignment.AlignCenter, btnLeft + TEXT_OFFSET, btnTop + TEXT_OFFSET, BUTTON_WIDTH, BUTTON_HEIGHT)
            End If

            If Input.IsMouseDown(MouseButton.LeftButton) And IsMouseOverMenu(i, level, xOffset) Then
                Graphics.DrawRectangle(HIGHLIGHT_COLOR, btnLeft, btnTop, BUTTON_WIDTH, BUTTON_HEIGHT)
            End If
        Next
    End Sub
    ...
    Private Sub PerformSetupMenuAction(ByVal button As Integer)
        'TODO: Step 04: Add actions based upon button selected
