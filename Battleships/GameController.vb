...
Public Module GameController
    ...
    Private _aiSetting As AIOption = AIOption.Medium
    ...
    Private Sub PlayHitSequence(ByVal row As Integer, ByVal column As Integer, ByVal showAnimation As Boolean)
        ...
        'TODO: Step 05: Play Hit sound here
    ...
    Private Sub PlayMissSequence(ByVal row As Integer, ByVal column As Integer, ByVal showAnimation As Boolean)
        ...
        'TODO: Step 05: Play Miss sound here
    ...
    ''' <param name="column">the index of the column hit</param>
    ''' <param name="showAnimation">if animation should be shown</param>
    Private Sub PlaySinkSequence(ByVal row As Integer, ByVal column As Integer, ByVal showAnimation As Boolean)
        PlayHitSequence(row, column, showAnimation)
        'TODO: Step 05: Play "Sink" sound effect here
    End Sub
    ...
    Private Sub PlayGameOverSounds()
        'TODO: Step 05: Play game over sound effects here.
    End Sub
    ...
    Private Sub AttackCompleted(ByVal sender As Object, ByVal result As AttackResult)
        ...
        'TODO: Step 11: Remove the following line of code
        DrawScreen()
        ...
        Select Case result.Value
            ...
            Case ResultOfAttack.GameOver
                ...
                'TODO: Step 05: Add code to delay until the "Sink" sound has ended
            ...
            Case ResultOfAttack.ShotAlready
                'TODO: Step 05: Play the "Error" sound effect here
        End Select
    End Sub
    ...
    Public Sub DrawScreen()
        ...
        Select Case CurrentState
            'TODO: Step 02: Add a case for the Deploying state
            Case GameState.ViewingMainMenu
                DrawMainMenu()
            Case GameState.ViewingGameMenu
                DrawGameMenu()
    ...
    ''' </summary>
    Public ReadOnly Property AISetting() As AIOption
        Get
            Return _aiSetting
        End Get
    End Property
